...
const loan =[{name:"Total Loan Amount", value:"GHS 50,000"},
...
const Repayment = () => {
  ...
  return (
    <section className="font-poppins p-5">
      <div className=" mb-2 p-10 bg-white rounded-md ">
          ...
          {loan.map((loans,index)=>(
            ...
            <p className="font-medium text-2xl text-black mt-3">{loans.value}</p>
          </div>
