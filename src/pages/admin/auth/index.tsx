...
import { ADMIN_DASHBOARD, SIGNUP } from "@/constants/page-path";
    ...
    <div className="w-full flex flex-col gap-y-10">
      <div>
        ...
        <p className="text-[#A3A3A3] font-normal mobile:text-sm">
          Log in to access your Management Portal
        </p>
      </div>
      <form onSubmit={handleSubmit} className="w-full flex flex-col gap-y-2">
        ...
        <button
          ...
          type="submit"
          className={`bg-[#17567E] w-52 h-12 flex justify-center items-center rounded-md text-white mobile:text-sm mx-auto my-3 mobile:py-2 mobile:px-10 ${
