      ...
      <section className="p-3 md:p-8 bg-white rounded-md mt-5">
        <div className="border-[0.5px] border-[#71839B] p-3 md:p-8 rounded-md flex items-start justify-between gap-5 shadow ">
          <div className="">
            ...
            <p className="font-light text-sm md:text-base text-[#545454] mt-6 mb-2">Project Name</p>
            <h2 className="font-semibold md:text-2xl text-[#252525] ">
              {search?.purpose ?? "N/A"}
            </h2>
            <p className="font-light text-sm md:text-base text-[#545454] mt-6 mb-2">
              Reporting Date
            </p>
            <h2 className="font-semibold md:text-2xl text-[#252525] ">
        ...
        <div className="my-5 border-[0.5px] border-[#71839B] p-3 md:p-8 rounded-md shadow ">
          ...
          <div className="bg-[#F6F6F6] py-2.5 px-2 md:px-4 rounded-md mb-2.5 flex flex-col gap-4 md:flex-row justify-between md:items-center">
            ...
            <div className="flex items-center gap-4">
              <button
                ...
                className="flex items-center gap-2 border border-[#71839B] text-[#545454] md:text-lg px-4 py-1.5 rounded-md hover:shadow-md transition-all duration-150 ease-in-out"
              >
                <Eye
                  size="22"
                  color="#545454"
