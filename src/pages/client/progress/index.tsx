      ...
      <td className="px-4 py-3">
        <div className="flex flex-col md:flex-row justify-between md:items-center gap-4 border-[0.5px] border-[#71839B] rounded-md shadow-sm p-3 md:p-6 mb-5">
          <div className="">
            ...
            <p className="font-light text-sm md:text-base text-[#545454] my-3">
              {" "}
          ...
          <div className="flex items-center space-x-3">
            <button
              ...
              className="font-poppins text-sm md:text-base font-light w-full md:w-40 h-10 flex justify-center items-center border border-[#324054] rounded-md text-[#324054] hover:bg-[#324054] hover:text-white transition-all duration-200 ease-in-out "
            >
              View Details
            </button>
            <button
              ...
              className="font-poppins font-light text-sm md:text-base w-full md:w-40 h-10 flex justify-center items-center border border-[#CE5347] rounded-md text-[#CE5347] hover:bg-[#CE5347] hover:text-white transition-all duratioin-200 ease-in-out "
            >
              Delete
            </button>
          </div>
